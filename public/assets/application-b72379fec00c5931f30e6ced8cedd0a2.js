   ...
   */
    ...
    SingleSelect2 = clazz(AbstractSelect2, {
        ...
        opening: function () {
            ...
            if (this.opts.shouldFocusInput(this)) {
                ...
                // orig_new text will appear *before* focusser.val()
    ...
    MultiSelect2 = clazz(AbstractSelect2, {
        ...
        onSelect: function (data, options) {
            ...
            // added we do not need to check if this is a orig_new element before firing change
